...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      className=" pb-24 px-[12vw] md:px-[7vw] lg:px-[16vw] font-sans bg-skills-gradient clip-path-custom-2 relative" >
      {/* Section Title */}
      <div className="text-center mb-16">
        <p className="text-gray-400 text-sm tracking-[3px] uppercase">
          <span className="text-teal-600">Explore</span> My
        </p>
        <h2 className="text-4xl font-bold text-white cursor-pointer hover:scale-105 transform transition-transform duration-300">EXPER
          ...
          <div
            ...
            <div
              ...
              <a href={experience.certificate}
                ...
                className="flex items-center gap-0.5 px-5 py-2.5 mt-5 rounded-full text-white font-medium bg-[#071e22]/80 backdrop-blur-xl shadow-[0_0_12px_rgba(79,183,179,0.25)] border border-[#4FB7B3]/40  hover:bg-[#0b2e33]/80 transition-all duration-300 w-32">
